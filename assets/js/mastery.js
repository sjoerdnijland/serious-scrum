    ...
    render() {
        ...
        return (
            <div className={containerClassName}>
                ...
                <a href="/pages/Road-to-Mastery-E-Book" target="_blank"><div className={itemClassName}>Get the E-Book!</div></a>
                <a href="/pages/introduction-to-the-road-to-mastery" target="_blank"><div className={itemClassName}>Introduction to the Road to Mastery</div></a>
                ...
                <a href="/pages/about-sjoerd-nijland"  target="_blank"><div className={itemClassName}>About Sjoerd Nijland</div></a>
