...
class PrismicCommand extends Command
{
    ...
    protected static $defaultDescription = 'Loads Prismic CMS pages.';
    ...
    {
        $this->setHelp('This command allows you to load pages from Prismic CMS | Serious Scrum - Road to Mastery...')
        ;
    }
